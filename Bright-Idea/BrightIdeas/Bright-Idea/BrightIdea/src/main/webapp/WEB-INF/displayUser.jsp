...
<body>
	<div class="col-10 mx-auto mt-5 ms-5">
		...
		<div>
			<h3 class="fs-1">Name:	${user.name} </h3>
		</div>
		<div>
		...
		<div class="d-flex col-6 justify-content-end">
			<h4 class="fs-3">Total Number of Posts:  <c:out value="${user.userIdea.size()}"/></h4>
			<h4 class="fs-3">Total Number of Likes:  <c:out value="${user.ideaLiked.size()}"/></h4>
		</div>
